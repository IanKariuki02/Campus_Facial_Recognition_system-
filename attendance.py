...
class Attendance:
    def __init__(self, root):
        ...
        self.var_atten_lecturer = StringVar()
        ...
        # background image
        img3 = Image.open(r"Images\Neoscape.png")
        ...
        title_lbl = Label(bg_img, text="ATTENDANCE MANAGE SECTION", font=("times new roman", 18, "bold"), bg="green",
                          fg="white")
        ...
        # Lecturer
        lecturerLabel = Label(left_inside_frame, text="Lecturer :", font=("times new roman", 12, "bold"), bg="white")
        lecturerLabel.grid(row=3, column=2, padx=2, pady=4, sticky=W)

        atten_lecturer = ttk.Entry(left_inside_frame, width=20, textvariable=self.var_atten_lecturer,
                                   font=("times new roman", 12, "bold"))
        atten_lecturer.grid(row=3, column=3, padx=8, pady=4, sticky=W)

        # Course
        courseLabel = Label(left_inside_frame, text="Course :", font=("times new roman", 12, "bold"), bg="white")
        courseLabel.grid(row=4, column=0, padx=2, pady=4, sticky=W)

        atten_course = ttk.Entry(left_inside_frame, textvariable=self.var_atten_course, width=20,
                                 font=("times new roman", 12, "bold"))
        atten_course.grid(row=4, column=1, padx=8, pady=4, sticky=W)
        ...
        self.AttendanceReportTable = ttk.Treeview(table_frame, columns=(
            "id", "roll", "name", "department", "time", "date", "attendance", "lecturer", "course"),
        ...
        self.AttendanceReportTable.heading("lecturer", text="Lecturer")
        ...
        self.AttendanceReportTable.column("lecturer", width=120)
    ...
    def action(self):
        ...
        lecturer = self.var_atten_lecturer.get()
        course = self.var_atten_course.get()
    ...
    def get_cursor(self, event):
        ...
        self.var_atten_lecturer.set(rows[7])
        self.var_atten_course.set(rows[8])
